...
For generating the the dll files, you have 2 choices as well : VC++ 7 (from v2.5) or MinGW 3.0 / 2.X 
(There's a project file for VC++ 6, but I've never tested it)	
...
the compiler flag or linker flag, pleas let me know.
